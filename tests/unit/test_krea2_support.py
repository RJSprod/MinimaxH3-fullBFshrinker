...
def _header(prefix=""):
    specs = {
        ...
        "txtfusion.projector.weight": (6144, 2560),
    }
    for i in range(28): specs.setdefault(f"blocks.{i}.attn.wq.weight", (6144, 6144))
    for i in range(12): specs[f"txtfusion.layerwise_blocks.{i}.prenorm.scale"] = (2560,)
    tensors = {}
    cursor = 0
...
def test_detects_prefixed_krea2_structurally():
